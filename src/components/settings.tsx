  ...
  return (
    <Box mx={20} mt={15}>
      ...
      <Box
        ...
        px={16}
      >
        <Text color="white">Include uppercase letters</Text>
        <Switch
          trackColor={{
            true: theme.color.purpleLightest,
            false: settingsValidation
              ? theme.color.redDark
              : theme.color.purpleLightest,
          }}
      ...
      <Box
        ...
        px={16}
      >
        <Text color="white">Include lowercase letters</Text>
        <Switch
          trackColor={{
            true: theme.color.purpleLightest,
            false: settingsValidation
      ...
      <Box
        ...
        px={16}
      >
        <Text color="white">Include numbers</Text>
        <Switch
          trackColor={{
            true: theme.color.purpleLightest,
            false: settingsValidation
      ...
      <Box
        ...
        px={16}
      >
        <Text color="white">Include symbols</Text>
        <Switch
          trackColor={{
            true: theme.color.purpleLightest,
            false: settingsValidation
